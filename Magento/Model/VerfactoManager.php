...
class VerfactoManager implements VerfactoManagerInterface
{
     ...
     */
    private VerfactoInterfaceFactory $verfactoModelFactory;

    /**
     * @var VerfactoRepositoryInterface
     */
    private VerfactoRepositoryInterface $verfactoRepository;

    /**
     * @var ViewCollectionFactory
     */
    private ViewCollectionFactory $trackingCollectionFactory;
