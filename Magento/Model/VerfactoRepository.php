...
class VerfactoRepository implements VerfactoRepositoryInterface
{
     ...
     * @var VerfactoFactory
     */
    private VerfactoFactory $entityFactory;
     ...
     */
    private VerfactoSearchResultInterfaceFactory $searchResultsFactory;

    /**
     * @var VerfactoResourceFactory
     */
    private VerfactoResourceFactory $entityResourceFactory;

    /**
     * @var VerfactoResource
     */
    private VerfactoResource $verfactoResource;
